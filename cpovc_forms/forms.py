...
SCHOOL_GRADE = (('GRADER', 'Grader'), ('FORM', 'Form'), ('YEAR', 'Year'))
FAMILY_MEMBERS_CHOICES = (('AMOTHER', 'Mother (1)'), ('ANNO', 'Father (2)'), ('AREFUSE', 'Aunt (3)'),
